...
public:
	...
	float get_latitude() { return lat*RAD_TO_DEG; }
	void set_latitude(float l) { lat = l*DEG_TO_RAD; }
	float get_longitude() { return lng*RAD_TO_DEG; }
	void set_longitude(float l) { lng = l*DEG_TO_RAD; }
...
public:
	...
	float get_altitude() { return alt; }
	void set_altitude(float a) { alt = a; }
protected:
    float alt = 0;
};
