...
public:
	...
	void connect(SlotBase0<R>& s) { slot = &s; }
...
{
public:
	virtual R callback(ARG1 a1) { return R(); }
};
...
public:
	...
	void connect(SlotBase1<R, ARG1>& s) { slot = &s; }
...
{
public:
	virtual R callback(ARG1 a1, ARG2 a2) { (void)a1; (void)a2; return R(); }
};
...
public:
	...
	void connect(SlotBase2<R, ARG1, ARG2>& s) { slot = &s; }
